...
@section('title', 'Alhuda Poultry Form - Sales Weekly Report')
 ...
 <div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <form class="forms-sample" method="POST" action="{{route('admin.sales.view.history')}}">
                <div class="card">
                    @csrf
                    <div class="card-header"><h4>Sales Report</h4></div>
                    <div class="card-body">
                        <div class="row">
                            <div class="title m-3"><strong>Note: </strong>Please select a company and provide the sheds for viewing the sales report.</div>
                            <div class="col col-6">
